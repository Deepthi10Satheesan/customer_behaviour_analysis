...
--Q1. What is the total revenue generated by male vs famale customer?
...
select item_purchased, ROUND(cast(AVG(review_rating)as numeric), 2) as "Average Product Rating"
from customer
